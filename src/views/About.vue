  ...
  <div class="card mb-3 bg-transparent" style="max-width: auto;">
    <div class="row no-gutters mobile-sass">
      <div class="col-md-5">
        <img src="../assets/profile.jpeg" class="img-fluid card-img" alt="Profile Picture" />
      </div>
      <div class="col-md-7 d-flex">
        <div class="card-body align-self-center custom-header">
          <h5 class="card-title display-1">Yassin AlTaha</h5>
          <h5>Software Developer / Web designer.</h5>

          <p class="card-text">
           Award winning software developer, graduated from Sheridan College with a degree in Computer System Analysis and minor in Art Fundamentals .
          </p>

          <div class="links links-backdrop mt-5">
            ...
            <a href="https://github.com/yassinaltaha">
              <img src="../assets/github2.png" alt="gitHub-logo" class="link-img" />
            </a>
          </div>
        </div>
      </div>
